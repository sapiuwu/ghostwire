export function frameByteLength(width, height) {
    return width * height * 4;
}
export function createScreenFrame(width, height, timestampMs) {
    return {
        width,
        height,
        format: 'bgra8',
...
export function scaleFrameNearest(src, dstWidth, dstHeight) {
